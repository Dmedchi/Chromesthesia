window.onload = function () {
    ...
    // считываем со страницы стоимость заказа
    let order_total_cost = parseFloat($(`.order_total_cost`).text().replace(',', '.')) || 0;
    console.log(order_total_quantity, order_total_cost);

    // считываем количество каждого продукта и его цену в массивы 'quantity_arr' и 'price_arr' в цикле
    ...
    // обрабатывает событие изменения количества товаров в заказе
